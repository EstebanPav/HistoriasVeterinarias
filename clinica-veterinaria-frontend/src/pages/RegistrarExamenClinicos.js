...
const RegistrarExamenClinico = () => {
    ...
    useEffect(() => {
        const fetchMascotas = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/mascotasHistorial');
    ...
    return (
        <div className="form-container">
            <form onSubmit={handleSubmit}>
                <h2>Registrar Examen Clínico</h2>
                ...
                <label>Actitud:</label>
                <select name="actitud" value={formData.actitud} onChange={handleChange} required>
                ...
                <select name="condicion_corporal" value={formData.condicion_corporal} onChange={handleChange} required>
                ...
                <select name="hidratacion" value={formData.hidratacion} onChange={handleChange} required>
                ...
                <fieldset>
                    ...
                    {['conjuntiva', 'oral', 'vulvar_prepu', 'rectal', 'ojos', 'oidos', 'nodulos', 'piel_anexos'].map((campo) => (
                        <div key={campo}>
                ...
                {/* Campos de Sistemas */}
                {['locomocion', 'musculo', 'nervioso', 'cardiovascular', 'respiratorio', 'digestivo', 'genitourinario'].map((sistema) => (
