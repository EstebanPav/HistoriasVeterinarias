...
const HistoriasClinicasTable = () => {
    ...
    const fetchHistoriasClinicas = async () => {
        try {
            const response = await axios.get("http://localhost:5000/api/historias_clinicas");
    ...
    const fetchVeterinarios = async () => {
        try {
            const response = await axios.get("http://localhost:5000/api/veterinarios");
    ...
    const handleSave = async () => {
        try {
            await axios.put(`http://localhost:5000/api/historias_clinicas/${editHistoria}`, formData);
