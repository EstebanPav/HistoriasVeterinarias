...
import 'react-toastify/dist/ReactToastify.css'; // Estilos de los Toasts
import api from '../api';
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <select className="form-control" name="propietario_id" value={mascota.propietario_id} onChange={handleChange} required>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <select className="form-control" name="especie" value={mascota.especie} onChange={handleChange}>
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <select className="form-control" name="sexo" value={mascota.sexo} onChange={handleChange}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" className="form-control" name="raza" value={mascota.raza} onChange={handleChange} />
                        </div>

                        <div className="col-md-6 mb-3">
                            <label className="form-label">Color:</label>
                            <input type="text" className="form-control" name="color" value={mascota.color} onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="date" className="form-control" name="fecha_nacimiento" value={mascota.fecha_nacimiento} onChange={handleChange} />
                        </div>

                        <div className="col-md-6 mb-3">
                            <label className="form-label">Edad:</label>
                            <input type="number" className="form-control" name="edad" value={mascota.edad} onChange={handleChange} min="0" />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <select className="form-control" name="procedencia" value={mascota.procedencia} onChange={handleChange}>
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" className="form-control" name="chip" value={mascota.chip} onChange={handleChange} />
                        </div>
                    </div>
